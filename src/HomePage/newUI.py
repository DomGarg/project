...
"background-image: url(:/newback/newbackground.jpg);")
        ...
        self.pushButton.setGeometry(QtCore.QRect(280, 630, 200, 45))
...
"")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(280, 680, 200, 45))
...
"background: transparent;")
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(280, 580, 200, 45))
        self.pushButton_5.setMinimumSize(QtCore.QSize(200, 45))
        self.pushButton_5.setAutoFillBackground(True)
        self.pushButton_5.setStyleSheet("background-image: url(:/finalbordd/button1.css);\n"
"border-color: rgb(0, 0, 0);\n"
"font: 8pt \"Yu Gothic\";\n"
"\n"
"")
        ...
        self.pushButton_5.clicked.connect(self.installPack)
    ...
    def installPack(self):
            from subprocess import Popen
            self.p2 = Popen(["npm", "install"], shell=True, stdin=None, stdout=None, stderr=None, close_fds=True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_4.setText(_translate("MainWindow", "Open in Web Browser"))
        self.label.setText(_translate("MainWindow", "Citizen Science Web Creator"))
        self.label_2.setText(_translate("MainWindow", "Welcome"))
        self.pushButton_5.setText(_translate("MainWindow", "Install Package"))
