...
orgpath = str(abspath(getsourcefile(lambda:0)))

print (os.path.dirname(os.path.realpath(sys.argv[0])))
newpath = str(os.path.dirname(os.path.realpath(sys.argv[0])))
#symbols = "\"
#newpath1 = newpath + symbols
print (newpath)
os.chdir(newpath)
print (os.getcwd())
...
class Application(Frame):
    ...
    def makeEdits(self):
        ...
        self.inputSelect = OptionMenu(self.window, self.inputType, "Text Input", "Time Input", "Date Input", "Slider", "Radio Button", "Checkbox")
    ...
    def changeWindow(self):
        ...
        self.my_entry5 = Entry(self.bgWindow, textvariable=5)
    ...
    def textWindow(self):
        ...
        self.my_entry3 = Entry(self.bgWindow, textvariable=3)
    ...
    def codeWindow(self):
        ...
        y = (self.bgWindow.winfo_screenheight() // 2) - (height // 2)
        self.bgWindow.geometry('{}x{}+{}+{}'.format(width, height, x, y))
        self.topFrame = Label(self.bgWindow, text="Change Admin Access Code", underline=True, font="Helvetica 9", fg="white")
        self.topFrame['bg'] = self.topFrame.master['bg']
        f = font.Font(self.topFrame, self.topFrame.cget("font"))
        f.configure(underline = True)
        self.topFrame.configure(font=f)
    ...
    def apiWindow(self):
        ...
        self.my_entry21 = Entry(self.bgWindow, textvariable=2)
